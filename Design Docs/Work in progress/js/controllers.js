...
GcmEmeaApp.controller('ItemCtrl', function ($scope) {
  ...
  "OrderGroup": {
	...
	if($scope.emptyCheck(item.ConfigDetails.Modules.Module)||$scope.getFulfillmentUnit(item.Id)==null||$scope.getFulfillmentUnit(item.Id).ComplexConfigId!="0")
	{return 1;}
	else
	{return 0;}
	}
 ...
 GcmEmeaApp.controller('OgSummaryCtrl', function ($scope) {
	$scope.formData= {
  "?xml": {
    "@version": "1.0"
  },
